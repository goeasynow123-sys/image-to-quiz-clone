...
const QuizFlow = () => {
  ...
  return (
    <div className="h-[100dvh] w-full bg-background max-w-[500px] mx-auto flex flex-col overflow-hidden fixed inset-0 shadow-2xl sm:border-x sm:border-border box-border overflow-x-hidden">
      {step < 11 && step !== 7 && (
