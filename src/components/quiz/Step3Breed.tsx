  ...
  return (
    <div className="quiz-screen">
      ...
      <div className="quiz-scroll space-y-3 pb-3">
        <div>
          <h2 className="text-sm font-bold text-gray-800 mb-2">Qual a raça do seu cão?</h2>
        ...
        <div>
          <h2 className="text-sm font-bold text-gray-800 mb-2">Qual o nome do seu companheiro?</h2>
          <input
            type="text"
